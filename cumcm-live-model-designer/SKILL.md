...
description: 面向中国大学生数学建模竞赛正在进行时的赛时模型设计与冻结。用户已完成拆题并需要为一个或多个小问建立 baseline、比较候选模型、定义公式变量约束、制定验证与故障降级方案、生成可供 Python 或 MATLAB 编码及论文写作交接的模型合同时使用；不用于赛前教学、模型百科或脱离题面数据的泛泛推荐。
---
