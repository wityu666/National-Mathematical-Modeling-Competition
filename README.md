...
- 正文实测页数须满足用户已确认的内部质量门 24–30 页，附录页数不设上限；必须按最终 PDF 记录正文起始页、附录起始页和实测正文页数，低于下限或超过上限均为 `BLOCKED/P0`。若当届官方上限低于 24 页，24 页下限自动失效并以官方上限为准；不得靠放大图文、扩大间距、重复内容或无关材料注水凑页数。
