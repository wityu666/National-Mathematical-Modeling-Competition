...
- 提交论文附录只保留关键建模代码和必要补充结果，其中必须覆盖主要建模代码，并须在最终 PDF 登记 `appendix_code_pdf_page`；缺少代码、未定位代码页或以截图/导包/通用辅助代码冒充时立即 `BLOCKED_APPENDIX_CODE/P0`。不写“完整程序与支撑材料索引”“支撑材料清单”或内部工程文件列表；完整程序、冻结清单、哈希、验证报告、追踪表和图形注册表保留在论文外部交付/审计材料中。AI 使用披露仍按当届官方规则单独处理。
